...
var _webImmediateJs = require("core-js/modules/web.immediate.js"); // Load the recipe when the page loads
...
const showRecipe = async function() {
    try {
        ...
        console.log(id);
        renderSpinner(recipeContainer); // Show spinner while fetching data
        // Fetching the recipe data using the Fetch API, handling errors
        ...
        console.log(recipe);
        // Rendering the recipe to the DOM
        const markup = `
...
},{}]},["appxp","7dWZ8"], "7dWZ8", "parcelRequire23ea", {}, "./", "/")
